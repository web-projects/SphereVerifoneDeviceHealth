...
namespace Devices.Verifone
{
    ...
    internal class VerifoneDevice : IDisposable, ICardDevice
    {
        ...
        private int StandAloneModeOutput((DeviceInfoObject deviceInfoObject, int VipaResponse) deviceIdentifier,
            ...
            (KernelConfigurationObject kernelConfigurationObject, int VipaResponse) emvKernelInformation)
        {
            Console.WriteLine(string.Format("DEVICE: STATUS => PROD-KEY=0x{0:X4}|TEST-KEY=0x{0:X4}|DEBITPIN-KEY=0x{0:X4}|KERNEL=0x{0:X4}", 
                configProd.VipaResponse, configTest.VipaResponse, configDebitPin.VipaResponse, emvKernelInformation.VipaResponse));
            return 0;
        }
        ...
        public void SetDeviceSectionConfig(DeviceSection config, Execution mode)
        {
